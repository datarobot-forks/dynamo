...
class VllmWorker:
    ...
    def __init__(self):
        ...
        self.namespace, component_name = VllmWorker.dynamo_address()  # type: ignore
        logger.info(f"DATAROBOT_DEBUG VllmWorker namespace: {self.namespace} component_name: {component_name}")
        ...
        if self.engine_args.router in (RouterType.KV, RouterType.APPROX_KV):
            ...
            os.environ["VLLM_KV_NAMESPACE"] = self.namespace
